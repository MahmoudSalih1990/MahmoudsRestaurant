...
class ConveyThis
{
    ...
    function reqOnGetSettingsUser() {
        ...
        $req_method = "GET";
        $request_uri = '/plugin/settings/'. $this->variables->api_key .'/'. $domain_name .'/';
        $headers = [
...
//                        continue;
    ...
    private function deleteQueryParams($url) {
    ...
    public function getLocation( $prefix, $language_code )
    {
        ...
        $_url = $this->deleteQueryParams($_SERVER["REQUEST_URI"]);
    ...
    public function _inline_script()
    {
        ...
        if (!empty($this->variables->api_key)) {
            ...
            wp_enqueue_script('conveythis-notranslate', plugins_url('../widget/js/notranslate.js', __FILE__));
